...
class address_countries {
    ...
    public $fields = array(
        ...
        array('name' => 'name', 'type' => 'varchar(100)', 'null' => 'YES', 'key' => '', 'default' => '', 'extra' => ''),
        ...
        array('name' => 'created_at', 'type' => 'timestamp', 'null' => 'NO', 'key' => '', 'default' => 'current_timestamp()', 'extra' => 'on update current_timestamp()'),
