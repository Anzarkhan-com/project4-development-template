function getElements(
  ...
  console.log("auto_load_till_page", auto_load_till_page);
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      console.log("total_rows_loaded", total_rows_loaded);
      ...
      if (data != "") {
        ...
        console.log("load_more_current_page", load_more_current_page);
